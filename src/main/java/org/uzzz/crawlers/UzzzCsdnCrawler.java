...
public class UzzzCsdnCrawler {
	...
	public long url(String url) throws IOException {
		try {
			...
			_conn.header("Cookie",
					"acw_tc=276082a815712952382655122eed6b06762cba907084fcb131195c81e84384; uuid_tt_dd=10_6645302180-1571295255786-680136; dc_session_id=10_1571295255786.817693; acw_sc__v2=5da8100607eda6745f48da25d19928eaf06ff80a");
...
//			log.error(_doc.html());
	...
	public void postWpUzzz(//
		...
		try {
			...
			ResponseEntity<String> res = rest.postForEntity( //
					"http://wp.uzzz.org/wp-json/wp/v2/posts", entity, String.class);
	...
	public int tagId(String tag) {
		...
		try {
			...
			res = rest.postForObject( //
					"http://wp.uzzz.org/wp-json/wp/v2/tags", entity, String.class);
	...
	public int categoryId(String category) {
		...
		try {
			...
			// 执行HTTP请求
			res = rest.postForObject( //
					"http://wp.uzzz.org/wp-json/wp/v2/categories", entity, String.class);
			return new JSONObject(res).optInt("id");
		} catch (HttpClientErrorException e) {
			res = e.getResponseBodyAsString();
			try {
